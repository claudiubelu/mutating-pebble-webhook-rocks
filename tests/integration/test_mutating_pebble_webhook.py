...
def webhook_instance(module_instance: harness.Instance, tmp_path: pathlib.Path):
    clone_path = tmp_path / "mutating-pebble-webhook-rocks"
...
def webhook_instance(module_instance: harness.Instance):
    ...
    file_updates = {
        "webhook-deployment.yaml": {
            ...
            "claudiubelu/pebble-mutating-webhook:0.0.1": rock.image,
        },
        "webhook-secret.yaml": {
